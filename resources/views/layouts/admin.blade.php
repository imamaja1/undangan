        ...
        <aside class="hidden lg:flex fixed inset-y-0 left-0 z-40 w-64 flex-col bg-gray-950 text-gray-300">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4">
                ...
                $menuGroups = [
                    ...
                    'Tamu & Interaksi' => [
                        ['route' => 'admin.guests.index', 'label' => 'Daftar Tamu', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z'],
                    ...
                    'Sistem Otomasi' => [
                        ['route' => 'admin.whatsapp.index', 'label' => 'Otomasi WA', 'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
                    ]
                ];
                @endphp
                ...
                <div class="mb-5">
                    <h3 class="px-3 mb-2 text-[10px] font-semibold text-gray-500 uppercase tracking-widest">{{ $groupName }}</h3>
