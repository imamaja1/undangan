        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div class="text-center" data-reveal="left">
                <div class="frame-round rounded-full w-52 h-52 md:w-60 md:h-60 mx-auto mb-8">
                    <img src="{{ asset('images/groom/groom.jpg') }}?v={{ file_exists(public_path('images/groom/groom.jpg')) ? filemtime(public_path('images/groom/groom.jpg')) : time() }}" alt="{{ $wedding->couple['groomName'] ?? '' }}" class="w-full h-full object-cover" loading="lazy" onerror="this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22300%22 height=%22400%22><rect fill=%22%231a1410%22 width=%22300%22 height=%22400%22/><text x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23E8B4B8%22 font-size=%2248%22>G</text></svg>'">
                </div>
            ...
            <div class="text-center" data-reveal="right">
                <div class="frame-round rounded-full w-52 h-52 md:w-60 md:h-60 mx-auto mb-8">
                    <img src="{{ asset('images/bride/bride.jpg') }}?v={{ file_exists(public_path('images/bride/bride.jpg')) ? filemtime(public_path('images/bride/bride.jpg')) : time() }}" alt="{{ $wedding->couple['brideName'] ?? '' }}" class="w-full h-full object-cover" loading="lazy" onerror="this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22300%22 height=%22400%22><rect fill=%22%231a1410%22 width=%22300%22 height=%22400%22/><text x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23E8B4B8%22 font-size=%2248%22>B</text></svg>'">
                </div>
