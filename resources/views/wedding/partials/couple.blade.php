<section id="couple" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/couple-bg.jpg') }}?v={{ @filemtime(public_path('images/hero/couple-bg.jpg')) }}')">
