<section id="couple" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/couple-bg.jpg') }}')">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <h2 class="font-serif text-3xl md:text-5xl text-white font-light tracking-wide text-center text-shadow mb-4" data-reveal="fade" data-reveal-delay="100">The Couple</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div class="text-center" data-reveal="left">
                ...
                <h3 class="font-serif text-2xl md:text-3xl font-light text-rose-light text-shadow">{{ $wedding->couple['groomName'] ?? '' }}</h3>
                <p class="text-champagne/50 mt-2 text-xs font-sans font-light">{{ $wedding->couple['groomParents'] ?? '' }}</p>
            </div>
            <div class="text-center" data-reveal="right">
                ...
                <h3 class="font-serif text-2xl md:text-3xl font-light text-rose-light text-shadow">{{ $wedding->couple['brideName'] ?? '' }}</h3>
                <p class="text-champagne/50 mt-2 text-xs font-sans font-light">{{ $wedding->couple['brideParents'] ?? '' }}</p>
            </div>
        </div>
    </div>
</section>
