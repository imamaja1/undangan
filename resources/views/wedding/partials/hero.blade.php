<section id="hero" class="min-h-[100dvh] flex items-center justify-center section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/hero-bg.jpg') }}')">
    ...
    <div class="relative z-10 w-full max-w-xl mx-auto px-6 text-center">
        ...
        <h2 class="font-serif text-4xl md:text-7xl text-white font-light mb-4 leading-tight tracking-wide text-shadow-lg" data-reveal="fade" data-reveal-delay="200">
        ...
        <h2 class="font-serif text-4xl md:text-7xl text-white font-light mb-8 leading-tight tracking-wide text-shadow-lg" data-reveal="fade" data-reveal-delay="400">
        ...
        <div class="mt-12 glass rounded-2xl p-6 shadow-2xl" data-reveal="up" data-reveal-delay="700">
            <p class="font-sans text-xs text-champagne/70 font-light leading-relaxed italic">"{{ $wedding->quotes['quran'] }}"</p>
