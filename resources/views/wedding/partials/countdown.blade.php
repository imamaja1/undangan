<section id="countdown" class="py-20 md:py-32 section-bg overlay-warm-dark section-fade-top" style="background-image: url('{{ asset('images/hero/countdown-bg.jpg') }}?v={{ $wedding->updated_at->timestamp ?? time() }}')">
