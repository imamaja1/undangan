<section id="wish" class="py-20 md:py-32 section-bg overlay-warm-dark section-fade-top" style="background-image: url('{{ asset('images/hero/wish-bg.jpg') }}')">
    <div class="relative z-10 max-w-lg mx-auto px-6">
        ...
        <h2 class="font-serif text-3xl md:text-5xl text-white font-light tracking-wide text-center text-shadow mb-4" data-reveal="fade" data-reveal-delay="100">Wedding Wish</h2>
        ...
        <div id="wishList" class="space-y-4 max-h-[500px] overflow-y-auto pr-1">
            ...
            <div class="glass rounded-2xl p-5 shadow-xl">
                ...
                <p class="font-sans text-sm text-champagne/60 font-light leading-relaxed">{{ $wish->message }}</p>
            </div>
            @endforeach
        </div>
    </div>
