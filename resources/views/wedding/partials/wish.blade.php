<section id="wish" class="py-20 md:py-32 section-bg overlay-warm-dark section-fade-top" style="background-image: url('{{ asset('images/hero/wish-bg.jpg') }}?v={{ $wedding->updated_at->timestamp ?? time() }}')">
    <div class="relative z-10 max-w-lg mx-auto px-6">
        ...
        <form id="wishForm" class="glass-rose rounded-2xl p-6 md:p-8 shadow-2xl space-y-4 mb-10" data-url="{{ route('wishes.store') }}" onsubmit="submitWish(event)" data-reveal="up" data-reveal-delay="300">
            ...
            <div>
                ...
                <input type="text" id="wishName" required class="glass-input" placeholder="Nama Anda" value="{{ request()->query('to') }}">
            </div>
            <div>
