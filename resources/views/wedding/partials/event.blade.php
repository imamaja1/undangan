<section id="event" class="py-20 md:py-32 section-bg overlay-warm-dark section-fade-top" style="background-image: url('{{ asset('images/hero/event-bg.jpg') }}')">
    <div class="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <h2 class="font-serif text-3xl md:text-5xl text-white font-light tracking-wide text-center text-shadow mb-4" data-reveal="fade" data-reveal-delay="100">The Event</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="glass-rose rounded-2xl p-6 md:p-8 shadow-2xl accent-bar-top" data-reveal="{{ $i == 0 ? 'left' : 'right' }}" data-reveal-delay="{{ $i * 200 }}">
                <h3 class="font-serif text-xl text-rose-light font-light text-shadow mb-6">{{ $event->title }}</h3>
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-sans text-sm text-champagne/70 font-light">{{ $event->date }}</span>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-sans text-sm text-champagne/70 font-light">{{ $event->time }}</span>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-sans text-sm text-champagne/70 font-light">{{ $event->venue }}</span>
                    </div>
                </div>
