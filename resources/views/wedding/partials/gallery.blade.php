<section id="gallery" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/gallery-bg.jpg') }}')">
    <div class="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <h2 class="font-serif text-3xl md:text-5xl text-white font-light tracking-wide text-center text-shadow mb-4" data-reveal="fade" data-reveal-delay="100">Gallery</h2>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide px-2 pb-4">
                    <a href="{{ asset($photo->src) }}" data-lightbox="wedding-gallery" data-title="{{ $photo->title }}">
                        <div class="frame-round rounded-2xl overflow-hidden shadow-2xl border-2 border-white/10 hover:border-rose-base/50 transition-all duration-500">
