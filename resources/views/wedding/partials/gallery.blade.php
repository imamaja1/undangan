<section id="gallery" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/gallery-bg.jpg') }}?v={{ file_exists(public_path('images/hero/gallery-bg.jpg')) ? filemtime(public_path('images/hero/gallery-bg.jpg')) : time() }}')">
