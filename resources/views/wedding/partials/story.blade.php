<section id="story" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/story-bg.jpg') }}?v={{ @filemtime(public_path('images/hero/story-bg.jpg')) }}')">
