<section id="story" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/story-bg.jpg') }}')">
    <div class="relative z-10 max-w-2xl mx-auto px-6">
        ...
        <h2 class="font-serif text-3xl md:text-5xl text-white font-light tracking-wide text-center text-shadow mb-4" data-reveal="fade" data-reveal-delay="100">Love Story</h2>
        ...
        <div class="space-y-6">
            ...
            <div class="glass-rose rounded-2xl p-6 md:p-8 shadow-2xl accent-bar-top" data-reveal="up" data-reveal-delay="{{ $index * 150 }}">
                ...
                <p class="font-sans text-sm text-champagne/60 font-light leading-relaxed mt-3">{{ $story->description }}</p>
                @if($story->image)
