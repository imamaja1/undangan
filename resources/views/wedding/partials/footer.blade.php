<footer id="footer" class="py-20 section-bg overlay-warm-dark" style="background-image: url('{{ asset('images/hero/footer-bg.jpg') }}?v={{ $wedding->updated_at->timestamp ?? time() }}')">
    ...
    <div class="relative z-10 max-w-lg mx-auto px-6 text-center">
        ...
        <p class="text-champagne/40 font-sans text-sm font-normal mb-8" data-reveal="up" data-reveal-delay="200">{{ $wedding->quotes['closingText'] ?? '' }}</p>
