<section id="gift" class="py-20 md:py-32 section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/gift-bg.jpg') }}?v={{ $wedding->updated_at->timestamp ?? time() }}')">
