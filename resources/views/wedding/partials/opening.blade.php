<section id="opening" class="min-h-screen flex items-center justify-center section-bg overlay-warm" style="background-image: url('{{ asset('images/hero/opening-bg.jpg') }}')">
